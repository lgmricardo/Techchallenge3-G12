...
| P4 | Correção de typo (2025/26) | "de R$ 25.001/mês a R$ 3000/mês" → teto interpretado como R$ 30.000 (regra: teto<piso ⇒ teto×10); 1 registro afetado | Notebook 02 |
...
|---|---|---|---|---|
| Estatística/Economia | 9 | R$ 5.001 | R$ 1.500 – R$ 18.000 | **7 faixas** |
| Professor/Pesquisador | 16 | R$ 10.001 | R$ 5.000 – R$ 16.000 | 5 faixas |
| Produto (DPM/PM) | 33 | R$ 14.001 | R$ 10.000 – R$ 18.113 | 2 faixas |
| Análise de Dados | 599 | R$ 7.001 | R$ 7.000 – R$ 7.000 | estável |
